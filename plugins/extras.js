// plugins/extras.js — kylie-ai, readmore, url, upload, calc, cpu, anonymsg
'use strict';
const fs     = require('fs');
...
// ─────────────────────────────────────────────────────────────────────────────
// KYLIE-AI — AI image generation
// ─────────────────────────────────────────────────────────────────────────────
cmd({
  pattern: 'kylie-ai',
  alias: ['aigenerate', 'imagine'],
  desc: 'Generate an AI image from a prompt',
  category: 'ai',
  filename: __filename,
}, async (conn, mek, m, { from, q, reply }) => {
  if (!q) return reply('*Provide a prompt!*\nExample: :kylie-ai a sunset over mountains');
  try {
    ...
    console.error('kylie-ai error:', e.message);
