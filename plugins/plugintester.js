// plugins/plugintester.js — Queen Kylie Bot
...
cmd({
  pattern:  'plugintest',
  alias:    ['testplugin', 'loadcode', 'codetest'],
  ...
  if (!withCmd) return reply(
    ...
    `cmd({ pattern: 'test', desc: 'test', category: 'misc', filename: __filename }, async (conn, mek, m, { from, reply }) => {\n` +
